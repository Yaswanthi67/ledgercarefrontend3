...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '4.5rem' }}>
      ...
      {/* 2. DUAL PORTALS: FOR DONORS & FOR CHARITIES */}
      <section style={{ maxWidth: '1140px', margin: '0 auto', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <div style={{
            ...
            <Sparkles size={14} />
            <span>Dual Experience Platform</span>
          </div>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3.5vw, 2.5rem)', fontWeight: '800', color: '#ffffff', letterSpacing: '-0.02em', marginBottom: '0.6rem' }}>
            Built for Generous Donors & Audited Charities
          </h2>
          <p style={{ color: 'var(--text-secondary)', fontSize: '1rem', maxWidth: '680px', margin: '0 auto' }}>
            Whether you want to support emergency relief in Indian Rupees or raise transparent funding for non-profit operations, LedgerCare gives both sides cryptographic assurance.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem' }}>
          ...
          <div className="card" style={{
            ...
            background: 'linear-gradient(180deg, rgba(16, 185, 129, 0.07) 0%, rgba(15, 23, 42, 0.95) 100%)',
            display: 'flex',
            ...
            <div>
              ...
              <h3 style={{ fontSize: '1.6rem', fontWeight: '800', color: '#ffffff', marginBottom: '0.6rem' }}>
                Donate in ₹ with Zero MetaMask
              </h3>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '1.75rem' }}>
                Contribute directly in Indian Rupees using UPI, Google Pay, PhonePe, Paytm, or debit cards. The backend relayer handles the blockchain transaction, giving you cryptographic proof without requiring any crypto wallet.
              </p>

              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', marginBottom: '2.25rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', fontSize: '0.9rem', color: '#f1f5f9' }}>
                  <CheckCircle2 size={18} color="#34d399" />
                  <span>Instant UPI & QR Code Donations (₹100 to ₹1,00,000)</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', fontSize: '0.9rem', color: '#f1f5f9' }}>
                  <CheckCircle2 size={18} color="#34d399" />
                  <span>Immutable smart contract donation receipt & Tx hash</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', fontSize: '0.9rem', color: '#f1f5f9' }}>
                  <CheckCircle2 size={18} color="#34d399" />
                  <span>Track utilization with verified IPFS purchase bills</span>
                </div>
              </div>
            </div>
          ...
          {/* Card 2: For Charities */}
          <div className="card" style={{
            padding: '2.25rem',
            border: '1px solid rgba(59, 130, 246, 0.35)',
            background: 'linear-gradient(180deg, rgba(59, 130, 246, 0.07) 0%, rgba(15, 23, 42, 0.95) 100%)',
            display: 'flex',
            flexDirection: 'column',
            justifyContent: 'space-between',
            borderRadius: 'var(--radius-lg)',
            ...
            <div>
              ...
              <h3 style={{ fontSize: '1.6rem', fontWeight: '800', color: '#ffffff', marginBottom: '0.6rem' }}>
                Register Charity & Launch Campaigns
              </h3>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.92rem', lineHeight: 1.6, marginBottom: '1.75rem' }}>
                Register your non-profit organization with government certification numbers. Your credentials are cryptographically hashed and whitelisted on CharityRegistry.sol to unlock fundraising.
              </p>

              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', marginBottom: '2.25rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', fontSize: '0.9rem', color: '#f1f5f9' }}>
                  <CheckCircle2 size={18} color="#60a5fa" />
                  <span>Cryptographic hash whitelisting on CharityRegistry</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', fontSize: '0.9rem', color: '#f1f5f9' }}>
                  <CheckCircle2 size={18} color="#60a5fa" />
                  <span>Launch auditable campaigns with strict financial caps</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem', fontSize: '0.9rem', color: '#f1f5f9' }}>
                  <CheckCircle2 size={18} color="#60a5fa" />
                  <span>Anchor expenditure receipts & bills directly to IPFS</span>
                </div>
              </div>
            </div>
